...
console.log(printFullName('Rajan', 'Yeta'))
```
...
console.log(greetings('Ajus'))
```

```js
function generateFullName(firstName = 'Asab', lastName = 'Yeta') {
  let space = ' '
  let fullName = firstName + space + lastName
  return fullName
}
...
const greetings = (name = 'Peter') => {
  let message = name + ', welcome to Uki!'
  return message
}
...
```js
const generateFullName = (firstName = 'Asabe', lastName = 'Yeta') => {
  let space = ' '
  let fullName = firstName + space + lastName
  return fullName
}
